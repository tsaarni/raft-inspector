...
EOF`)
	...
	out = doc.Run("./raft-inspector status --data-dir testdata/node0")
	...
	out = doc.Run("./raft-inspector log --data-dir testdata/node0 ~3 \\\n    --unseal-key-file testdata/init.json")
	...
	out = doc.Run("./raft-inspector log --data-dir testdata/node0 --stats")
	...
	out = doc.Run("./raft-inspector fsm --data-dir testdata/node0")
	...
	out = doc.Run("./raft-inspector fsm --data-dir testdata/node0 --prefix sys/policy/")
